...
public class Dto {
	...
	// 투표검수용 생성자
		public Dto(String v_name, String v_jumin , String m_no, String v_time, String v_confirm) {
		super();
		this.v_jumin = v_jumin;
		this.v_name = v_name;
		this.m_no = m_no;
	...
	public Dto(String mno, String m_name, String p_name, String p_school, String m_jumin, String m_city, String p_tel1,
	...
	public String toString() {
		return "Dto [mno=" + mno + ", m_name=" + m_name + ", p_name=" + p_name + ", p_school=" + p_school + ", m_jumin="
				+ m_jumin + ", m_city=" + m_city + ", p_tel1=" + p_tel1 + ", p_tel2=" + p_tel2 + ", p_tel3=" + p_tel3
				+ ", v_jumin=" + v_jumin + ", v_name=" + v_name + ", m_no=" + m_no + ", v_time=" + v_time + ", v_area="
				+ v_area + ", v_confirm=" + v_confirm + ", rank=" + rank + "]";
	}

...
public class Dto {
	...
	//검사결과조회 생성자
	public Dto(String p_no, String p_name, String t_name, String t_sdate, String t_status, String t_ldate,
			String t_result) {
		super();
		this.p_no = p_no;
		this.p_name = p_name;
	...
	//검사건수통계 생성자
	public Dto(String p_city, String p_city_name, int t_count) {
		super();
		this.p_city = p_city;

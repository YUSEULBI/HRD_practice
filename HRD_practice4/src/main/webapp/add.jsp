...
<body>
	...
	<center>
		<h3>검사결과입력</h3>
		<form name="addForm" action="/HRD_practice4/add/result" method="post">
			<table border="1" style="border-collapse: collapse; width: 500px; text-align: left;">
				<tr>
					<th>환자번호</th><th><input name="p_no" type="text" />예)1001</th>
				</tr>
				<tr>
					<th>검사코드</th>
					<th>
				...
				<tr>
					<th>검사시작일자</th><th><input name="t_sdate" type="text" />예)20200103</th>
				</tr>
				<tr>
					<th>검사상태</th>
					<th>
				...
				<tr>
					<th>검사완료일자</th><th><input name="t_ldate" type="text" />예)20200103</th>
				</tr>
				<tr>
					<th>검사결과</th>
					<th>
				...
				<tr style="text-align: center !important;">
					<th colspan="2">
						<button type="button" onclick="formSubmit()">검사결과등록</button>
